...
<?php
    ...
    $to = "hannaharntson@gmail.com"; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = "Website Contact"; // Choose a custom subject (not mandatory)

    $body = "You have received a message from " . $name . " (" . $email . "):\n\n" . $message;

    $from = "From: hannaharntson.com"; // Replace "Beetle Template" with your site name (not mandatory)   
    $headers = "From:" . $from . "\r\n";
    ...
    */ 
    ...
    $to = 'hannaharntson@gmail.com'; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = 'Website Message'; // Choose a custom subject (not mandatory)
